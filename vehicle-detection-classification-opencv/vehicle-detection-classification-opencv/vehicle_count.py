...
cap = cv2.VideoCapture("C:\Users\HARIHARAN\Downloads\vehicle-detection-classification-opencv\vehicle-detection-classification-opencv\bridge.mp4")
input_size = 320
...
## Model Files
modelConfiguration = 'C:\Users\HARIHARAN\Downloads\vehicle-detection-classification-opencv\vehicle-detection-classification-opencv\yolov3-320.cfg'
modelWeights = 'C:\Users\HARIHARAN\Downloads\vehicle-detection-classification-opencv\vehicle-detection-classification-opencv\yolov3-320.weights'

# configure the network model
net = cv2.dnn.readNetFromDarknet(modelConfiguration, modelWeights)

# Configure the network backend and target
